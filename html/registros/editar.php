...
<form class="container" method="POST">
	<div class="txt-center p5">
		...
		<a href="<?= $Register->url('ver') ?>" class="btn btn-default btn-ico-x">CANCELAR</a>
	</div>
	...
	<div class="row pt5">
		<label for="reg_fecha" class="form-group col-sm-6 m0">
			...
			<div class="col-xs-9 field field-blue">
				<input type="text" id="reg_fecha" value="<?= $Register->fecha ?>" name="fecha">
			</div>
		</label>
		<label for="reg_hora" class="form-group col-sm-6 m0">
			...
			<div class="col-xs-9 field field-blue">
				<input type="text" id="reg_hora" value="<?= $Register->hora ?>" name="hora">
			</div>
		</label>
		<div class="col-sm-6">
			<div class="col-xs-3 label">
		...
		<label for="reg_descripcion" class="form-group col-sm-12 m0">
			...
			<div class="col-xs-12 field field-blue field-read">
				<textarea id="reg_descripcion" name="descripcion"><?= $Register->descripcion ?></textarea>
			</div>
		</label>
	</div>
</form>