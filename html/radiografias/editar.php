		...
		<div class="row pt5">
			<label for="photo_date" class="form-group clear col-sm-6">
				...
				<div class="col-xs-9 field field-blue">
					<input type="text" id="photo_date" value="<?= $Radiographie->fecha_hora ?>" name="fecha_hora" class="input-date">
				</div>
			</label>
			<div class="form-group clear col-sm-6">
				...
				<div class="col-xs-9 field field-read field-radio-check field-blue">
					<input type="radio" id="r_etapa_iniciales" <?= checked($Radiographie->etapa == ETAPA_INICIALES) ?> value="<?= ETAPA_INICIALES ?>" name="etapa">
					<label for="r_etapa_iniciales">INICIALES</label>
					<input type="radio" id="r_etapa_intermedias" <?= checked($Radiographie->etapa == ETAPA_INTERMEDIAS) ?> value="<?= ETAPA_INTERMEDIAS ?>" name="etapa">
					<label for="r_etapa_intermedias">INTERMEDIAS</label>
					<input type="radio" id="r_etapa_finales" <?= checked($Radiographie->etapa == ETAPA_FINALES) ?> value="<?= ETAPA_FINALES ?>" name="etapa">
