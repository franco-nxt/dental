...
<form method="POST" enctype="multipart/form-data">
	<div class="bar-btn">
		<div class="container">
			...
			<a class="btn btn-default btn-ico-x" href="<?= URL_ROOT ?>/cefalometrias/modelos/<?=  $Patient->url ?>">CANCELAR</a>
		</div>
	</div>
	<div class="container">
		<div class="row pt5">
			...
			<div class="form-group clear col-sm-6 m0">
				...
				<div class="col-xs-9 field field-read field-radio-check field-blue">
					<input class="radio-input" type="radio" id="r_etapa_iniciales" value="<?= ETAPA_INICIALES ?>" name="etapa" <?= checked(true) ?>>
			...
			<div class="form-group clear col-sm-12 m0">
				...
				<div class="col-xs-9 field field-read field-radio-check field-blue">
					<input class="radio-input" type="radio" id="r_etapa_ricketts" value="<?= CEFALOMETRIA_RICKETTS ?>" name="tipo">
					<label class="radio-label" for="r_etapa_ricketts">RICKETTS</label>
					<input class="radio-input" type="radio" id="r_etapa_jarabak" value="<?= CEFALOMETRIA_JARABAK ?>" name="tipo">
					<label class="radio-label" for="r_etapa_jarabak">JARABAK</label>
					<input class="radio-input" type="radio" id="r_etapa_mcnamara" value="<?= CEFALOMETRIA_MCNAMARA ?>" name="tipo">
					<label class="radio-label" for="r_etapa_mcnamara">MCNAMARA</label>
					<input class="radio-input" type="radio" id="r_etapa_steiner" value="<?= CEFALOMETRIA_STEINER ?>" name="tipo">
					<label class="radio-label" for="r_etapa_steiner">STEINER</label>
					<input class="radio-input" type="radio" id="r_etapa_otro" value="<?= CEFALOMETRIA_OTRO ?>" name="tipo" <?= checked(true) ?>>
					<label class="radio-label" for="r_etapa_otro">OTRO</label>
					<input class="radio-input" type="radio" id="r_etapa_superposicion" value="<?= CEFALOMETRIA_SUPERPOSICION ?>" name="tipo">
